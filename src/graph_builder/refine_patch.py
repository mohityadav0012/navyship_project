...
def generate_patch(lat_min, lat_max, lon_min, lon_max, res=FINE_RES, land_mask=None):
    """Create a fine-resolution patch in bbox. Returns nodes (dict) and adj (dict)."""
    ...
    for k,v in nodes.items():
        ...
        for di,dj in offsets:
            ...
            if nk:
                dist = haversine_km(v["lat"], v["lon"], nodes[nk]["lat"], nodes[nk]["lon"])
